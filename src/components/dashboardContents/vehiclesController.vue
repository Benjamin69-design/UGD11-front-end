                ...
                <v-card-text>
                    <v-container>
                        <v-row>
                            ...
                            <v-col cols="12">
                                <v-text-field label="LicensePlate*" v-model="form.licensePlate" required>
                                </v-text-field>
                            </v-col>
                            <v-col cols="12">
    ...
    methods: {
        getData(){ 
            ...
            this.$http.get(uri).then(response =>{ 
                this.vehicle=response.data.message 
            }) 
        },
        ...
        deleteData(deleteId){ //mengahapus data 
            var uri = this.$apiUrl + '/vehicles/' + deleteId; //data dihapus berdasarkan id 
